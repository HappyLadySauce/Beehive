...
import (
	...
	"github.com/HappyLadySauce/Beehive/internal/beehive-message/options"
)
...
func NewAPICommand(basename string, ctx context.Context) *cobra.Command {
	...
	cmd := &cobra.Command{
		Use:   basename,
		Short: "BeehiveMessage is a message service for Beehive",
		Long:  "BeehiveMessage is a message service for Beehive",
