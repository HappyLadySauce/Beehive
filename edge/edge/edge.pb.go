...
const file_edge_proto_rawDesc = "" +
	"\n" +
	"\n" +
	"edge.proto\x12\x04edge\"\x1d\n" +
	"\aRequest\x12\x12\n" +
	"\x04ping\x18\x01 \x01(\tR\x04ping\"\x1e\n" +
	"\bResponse\x12\x12\n" +
	"\x04pong\x18\x01 \x01(\tR\x04pong2-\n" +
	"\x04Edge\x12%\n" +
	"\x04Ping\x12\r.edge.Request\x1a\x0e.edge.ResponseB\bZ\x06./edgeb\x06proto3"
...
var file_edge_proto_goTypes = []any{
	(*Request)(nil),  // 0: edge.Request
	(*Response)(nil), // 1: edge.Response
}
var file_edge_proto_depIdxs = []int32{
	0, // 0: edge.Edge.Ping:input_type -> edge.Request
	1, // 1: edge.Edge.Ping:output_type -> edge.Response
