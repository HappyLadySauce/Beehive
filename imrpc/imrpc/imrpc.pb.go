...
const file_imrpc_imrpc_proto_rawDesc = "" +
	"\n" +
	"\x11imrpc/imrpc.proto\x12\x05imrpc\"h\n" +
...
var (
	...
	file_imrpc_imrpc_proto_rawDescData []byte
)

func file_imrpc_imrpc_proto_rawDescGZIP() []byte {
	file_imrpc_imrpc_proto_rawDescOnce.Do(func() {
		file_imrpc_imrpc_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_imrpc_imrpc_proto_rawDesc), len(file_imrpc_imrpc_proto_rawDesc)))
	})
	return file_imrpc_imrpc_proto_rawDescData
}

var file_imrpc_imrpc_proto_msgTypes = make([]protoimpl.MessageInfo, 6)
var file_imrpc_imrpc_proto_goTypes = []any{
...
func file_imrpc_imrpc_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_imrpc_imrpc_proto_rawDesc), len(file_imrpc_imrpc_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   6,
			NumExtensions: 0,
			NumServices:   1,
