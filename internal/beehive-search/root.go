...
import (
	...
	"github.com/HappyLadySauce/Beehive/internal/beehive-search/options"
)
...
func NewAPICommand(basename string, ctx context.Context) *cobra.Command {
	...
	cmd := &cobra.Command{
		Use:   basename,
		Short: "BeehiveSearch is a search service for Beehive",
		Long:  "BeehiveSearch is a search service for Beehive",
